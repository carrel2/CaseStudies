...
class AdminController extends Controller
{
	...
	/**
	 * @Route("/admin/animals", name="animal")
	 */
	public function animalAction(Request $r)
	{
		...
		return $this->render('animals.html.twig', array(
			'form' => $form->createView(),
		));
	}

	/**
	 * @Route("/admin/hotspots", name="editHotspots")
	 */
	 public function hotspotsAction(Request $r)
	 {
		 $em = $this->getDoctrine()->getManager();
		 $animal = $em->getRepository('AppBundle:Animal')->findAll();

		 return $this->render('createHotspots.html.twig', array(
			 'animal' => $animal[0],
		 ));
	 }
}
